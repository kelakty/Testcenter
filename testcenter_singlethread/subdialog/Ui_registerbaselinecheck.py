...
class Ui_RegisterBaseLineCheck(object):
    def setupUi(self, RegisterBaseLineCheck):
        ...
        self.generateRegisterBaseLineExcel = QtWidgets.QPushButton(RegisterBaseLineCheck)
        self.generateRegisterBaseLineExcel.setGeometry(QtCore.QRect(180, 80, 75, 23))
        self.generateRegisterBaseLineExcel.setObjectName("generateRegisterBaseLineExcel")
        self.generateRegisterBaseLineReport = QtWidgets.QPushButton(RegisterBaseLineCheck)
        self.generateRegisterBaseLineReport.setGeometry(QtCore.QRect(300, 80, 111, 23))
    ...
    def retranslateUi(self, RegisterBaseLineCheck):
        ...
        self.generateRegisterBaseLineExcel.setText(_translate("RegisterBaseLineCheck", "生成表格"))
        self.generateRegisterBaseLineReport.setText(_translate("RegisterBaseLineCheck", "使用表格生成报告"))
