...
"selection-color: qconicalgradient(cx:0, cy:0, angle:135, stop:0 rgba(255, 255, 0, 69), stop:0.375 rgba(255, 255, 0, 69), stop:0.423533 rgba(251, 255, 0, 145), stop:0.45 rgba(247, 255, 0, 208), stop:0.477581 rgba(255, 244, 71, 130), stop:0.518717 rgba(255, 218, 71, 130), stop:0.55 rgba(255, 255, 0, 255), stop:0.57754 rgba(255, 203, 0, 130), stop:0.625 rgba(255, 255, 0, 69), stop:1 rgba(255, 255, 0, 69));")
        ...
        self.save_sequence_to_txt = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
        self.save_sequence_to_txt.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.save_sequence_to_txt.sizePolicy().hasHeightForWidth())
        self.save_sequence_to_txt.setSizePolicy(sizePolicy)
        self.save_sequence_to_txt.setStyleSheet(" border: none; \n"
"background-color: rgb(174, 255, 188);")
        self.save_sequence_to_txt.setAutoRaise(True)
        self.save_sequence_to_txt.setObjectName("save_sequence_to_txt")
        self.horizontalLayout_4.addWidget(self.save_sequence_to_txt)
...
"")
        ...
        self.sequencertable.setColumnCount(11)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.sequencertable.setHorizontalHeaderItem(10, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.save_sequence_to_txt.setText(_translate("MainWindow", "导出"))
        ...
        item.setText(_translate("MainWindow", "生成报告文件"))
        item = self.sequencertable.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "说明"))
        item = self.sequencertable.horizontalHeaderItem(10)
