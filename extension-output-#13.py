...
"background-color: rgb(174, 255, 188);")
        ...
        self.combinationkey = QtWidgets.QPushButton(self.dockWidgetContents_5)
        self.combinationkey.setObjectName("combinationkey")
        self.verticalLayout_3.addWidget(self.combinationkey)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.combinationkey.setText(_translate("MainWindow", "常用组合键"))
