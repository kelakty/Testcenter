...
"selection-color: qconicalgradient(cx:0, cy:0, angle:135, stop:0 rgba(255, 255, 0, 69), stop:0.375 rgba(255, 255, 0, 69), stop:0.423533 rgba(251, 255, 0, 145), stop:0.45 rgba(247, 255, 0, 208), stop:0.477581 rgba(255, 244, 71, 130), stop:0.518717 rgba(255, 218, 71, 130), stop:0.55 rgba(255, 255, 0, 255), stop:0.57754 rgba(255, 203, 0, 130), stop:0.625 rgba(255, 255, 0, 69), stop:1 rgba(255, 255, 0, 69));")
        ...
        self.Sequencer.setMinimumSize(QtCore.QSize(290, 334))
        ...
        self.toolButton_9 = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
        ...
        self.toolButton_10 = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
        ...
        self.toolButton_11 = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
        ...
        self.toolButton_12 = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
        ...
        self.toolButton_13 = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
        ...
        self.toolButton_16 = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
        ...
        self.toolButton_15 = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
...
"background-color: rgb(174, 255, 188);")
        ...
        self.toolButton_14 = QtWidgets.QToolButton(self.groupBoxSequenceToolBar)
...
"")
        ...
        self.test_sequencer = QtWidgets.QTableView(self.splitter)
        self.test_sequencer.setObjectName("test_sequencer")
        self.treeWidget_sequencer = QtWidgets.QTreeWidget(self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.treeWidget_sequencer.setColumnCount(9)
        ...
        self.sendbuffer_dockwidget.setMinimumSize(QtCore.QSize(176, 0))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.encodingtype.setItemText(1, _translate("MainWindow", "UTF-8"))
        ...
        self.treeWidget_sequencer.headerItem().setText(0, _translate("MainWindow", "终端"))
        self.treeWidget_sequencer.headerItem().setText(1, _translate("MainWindow", "命令"))
        self.treeWidget_sequencer.headerItem().setText(2, _translate("MainWindow", "等待回显时间"))
        self.treeWidget_sequencer.headerItem().setText(3, _translate("MainWindow", "待匹配文本"))
        self.treeWidget_sequencer.headerItem().setText(4, _translate("MainWindow", "执行完是否清空缓存"))
        self.treeWidget_sequencer.headerItem().setText(5, _translate("MainWindow", "单独保存log到文件"))
        self.treeWidget_sequencer.headerItem().setText(6, _translate("MainWindow", "插入报告"))
        self.treeWidget_sequencer.headerItem().setText(7, _translate("MainWindow", "说明"))
        self.treeWidget_sequencer.headerItem().setText(8, _translate("MainWindow", "备注"))
        __sortingEnabled = self.treeWidget_sequencer.isSortingEnabled()
        self.treeWidget_sequencer.setSortingEnabled(False)
        self.treeWidget_sequencer.topLevelItem(0).setText(1, _translate("MainWindow", "show version detail "))
        self.treeWidget_sequencer.topLevelItem(0).setText(7, _translate("MainWindow", "show信息"))
        self.treeWidget_sequencer.topLevelItem(0).setText(8, _translate("MainWindow", "客户端 dut1主"))
        self.treeWidget_sequencer.topLevelItem(0).child(0).setText(1, _translate("MainWindow", "scan"))
        self.treeWidget_sequencer.topLevelItem(0).child(0).setText(7, _translate("MainWindow", "识别对应信息是否正确"))
        self.treeWidget_sequencer.topLevelItem(0).child(1).setText(1, _translate("MainWindow", "print log"))
        self.treeWidget_sequencer.topLevelItem(0).child(1).setText(7, _translate("MainWindow", "打印报告"))
        self.treeWidget_sequencer.topLevelItem(1).setText(1, _translate("MainWindow", "sh pow "))
        self.treeWidget_sequencer.topLevelItem(1).setText(7, _translate("MainWindow", "show电源信息"))
        self.treeWidget_sequencer.topLevelItem(1).setText(8, _translate("MainWindow", "客户端 duit1 从"))
        self.treeWidget_sequencer.topLevelItem(1).child(0).setText(1, _translate("MainWindow", "scan"))
        self.treeWidget_sequencer.topLevelItem(1).child(0).setText(7, _translate("MainWindow", "识别对应信息是否正确"))
        self.treeWidget_sequencer.topLevelItem(2).setText(1, _translate("MainWindow", "XXX"))
        self.treeWidget_sequencer.topLevelItem(2).setText(7, _translate("MainWindow", "发包机打流"))
        self.treeWidget_sequencer.topLevelItem(2).setText(8, _translate("MainWindow", "客户端 发包机"))
        self.treeWidget_sequencer.topLevelItem(3).setText(1, _translate("MainWindow", "XXX"))
        self.treeWidget_sequencer.topLevelItem(3).setText(7, _translate("MainWindow", "自动上下电"))
        self.treeWidget_sequencer.topLevelItem(3).setText(8, _translate("MainWindow", "客户端 串口自动上下电工具"))
