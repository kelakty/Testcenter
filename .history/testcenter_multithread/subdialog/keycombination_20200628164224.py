...
class KeyCombination(QDialog, Ui_keycombination):
    ...
    def on_ctrlZ_clicked(self):
        ...
        # print("keycombination",bytes(0x1a),type(bytes(0x1a))) #错误用法，结果是b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' <class 'bytes'>
        # print("keycombination",bytes([0x1a]),type(bytes(0x1a))) #正确用法！！！
        consolethread.send_trigger.emit(input_s)
