...
###测试向导-创建测试###
    ...
    def on_action12_X_factory_auto_test_triggered(self):
        ...
        self.fac_auto_test_threadpool.started.connect( self.fac_auto_test_thread.sequencer_worker)
        ...
        self.fac_auto_test_thread.finished.connect(self.fac_auto_test_threadpool.quit)  # tell the thread it's time to stop running
