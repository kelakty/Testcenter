...
###测试向导-创建测试###
    ...
    def fac_auto_test_finished(self):
        self.current_console_index = self.find_dictionarylist_keyvalue_index(GlobalVariable.Console, "subwindowobj", self.mdiArea.currentSubWindow())
        GlobalVariable.Console[self.current_console_index]["consolethread"].rec_trigger.disconnect(self.sequencer_receive_data_slot, Qt.QueuedConnection)
        self.fac_auto_test_thread.fac_test_to_main_trigger.disconnect(self.sequencer_data_to_console_thread_slot, Qt.QueuedConnection) 
