...
a = ['0. 产品信息检测', '1. 温度检测', '2. 内存测试', '3. SPI Flash测试', '4. USB测试', '5. EMMC测试', '6. RTC测试', '7. I2C接口测试', '8. CPLD测试', '9. 端口收发帧测试', 'a. LED测试', 'b. 风扇状态检测', 'c. 电源状态检测', 'd. 端口广播测试', 'e. Prbs测试', 'f. 带外低速信号测试', 'g. 硬件双Boot测试', 'h. CPLD/FPGA在线升级接口测试', 'i. 管理口收发帧测试']
test_menu = {'0. 设置RTC时间': '0', '1. 单项测试': '1', '2. 所有测试': '2', '3. 烤机测试': '3', '4. 查看烤机结果': '4', '5. 删除烤机结果': '5', '6. 进入调试程序界面': '6', '7. 清除生产测试数据': '7', '8. 全局复位': '8', '9. 退出生产测试': '9'}
for i in range(len(a)):
    print(list(self.test_menu.keys()).count(test_name_list[i]))
