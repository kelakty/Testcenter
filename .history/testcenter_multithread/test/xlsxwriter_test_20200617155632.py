...
class Xlsx_Write():
    def test(self):
        ...
        Embedded_object.Add(ClassType=None, Filename=file_loction, Link=False, DisplayAsIcon=True,Left=worksheet.Cells(1,3).Left, Top=worksheet.Cells(1,3).Top, Width=50, Height=50)
