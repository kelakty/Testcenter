...
class Xlsx_Write():
    def test(self):
        ...
        worksheet.write("F1","")
        report_cell_format = workbook.add_format({'text_wrap': True,"valign":"vcenter","font_color":"blue"})
        report_cell_format.set_border()
        worksheet.conditional_format("G3:J3",{ 'type' : 'no_blanks','format':report_cell_format})
