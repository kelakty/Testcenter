...
class NewMdiSubWindow(QtWidgets.QMdiSubWindow):
    ...
    def closeEvent(self, event):
        ...
        if(result == QtWidgets.QMessageBox.Yes):
            ...
            print("当前线程的comThreadCounter是：",self.comThreadCounter)
            self.mainwindow.console_terminal_threadpool[self.comThreadCounter].quit()
            self.mainwindow.console_terminal_threadpool[self.comThreadCounter].wait()
