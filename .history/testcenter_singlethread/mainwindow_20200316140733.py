...
#
    ...
    def on_open_close_buttom_clicked(self):
        ...
        elif self.console_terminal_threadpool ==[]:
            console_terminal_threadpool.append(None)
        else:
            try:
                if console_terminal_threadpool[GlobalVariable.com_treadcounter] != None:
        ...
        if self.console_terminal_threadpool[GlobalVariable.com_treadcounter] != None:
            ...
            print("开始创建com线程")
            self.newCom_MdiTread(GlobalVariable.com_treadcounter)
        else:
            self.newCom_MdiTread(GlobalVariable.com_treadcounter)
