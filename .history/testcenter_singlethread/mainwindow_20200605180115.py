...
#                        self.console_terminal.setTextCursor(cursor)
                    ...
                    try:
                        ...
                        self.textEdit_message.insertPlainText("%s发送字符出错" % GlobalVariable.Console[index]["name"])
...
###工具栏按键###
    ...
    def rec_comdata_slot(self,serialobj,data):
        ...
        if index >= 0:
            ...
            console_terminal.insertPlainText(data.encode(GlobalVariable.Console[index]["encodingtype"]))
