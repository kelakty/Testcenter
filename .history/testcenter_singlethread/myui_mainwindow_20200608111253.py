...
from PyQt5.QtWidgets import QMainWindow,QAction,QLCDNumber 
...
class MyUi_MainWindow(object): #object
...
#        self.dockWidget.setAllowedAreas(QtCore.Qt.RightDockWidgetArea | QtCore.Qt.LeftDockWidgetArea)#设置dockWidget只停靠在左边栏
        ...
        self.lcd = QLCDNumber()
        self.lcd.setStyleSheet("color: rgb(0, 255, 255);background-color: rgb(210, 255, 255)")
        # self.lcd.setStyleSheet('background-color:#cbf7ff,color: black')
        self.lcd.setDigitCount(13)
        self.timetoolBar = QtWidgets.QToolBar(MainWindow)
        self.timetoolBar.setObjectName("toolBar")
        self.timetoolBar.addWidget(self.lcd)
        MainWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.timetoolBar)
