...
from serial_thread import SerialThread，analyze
...
#
    ...
    def on_open_close_buttom_clicked(self):
        ...
        if self.com_option.currentText() in GlobalVariable.opencomlist:
            ...
            self.newthread.rec_trigger.connect(self.rec_comdata_slot,Qt.QueuedConnection)
            self.newthread.send_trigger.connect(self.analyze.sendto_comdata_slot, Qt.QueuedConnection)
        """
