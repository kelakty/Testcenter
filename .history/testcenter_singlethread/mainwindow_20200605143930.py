    ...
    def closeEvent(self, event):
        ...
        if(result == QtWidgets.QMessageBox.Yes):
            ...
            if index >= 0:
                ...
                GlobalVariable.Console[index]["consoleobj"].rec_trigger.disconnect(self.mainwindow.rec_comdata_slot) 
                GlobalVariable.Console[index]["consoleobj"].send_trigger.disconnect(GlobalVariable.Console[index]["consoleobj"].sendto_comdata_slot)
