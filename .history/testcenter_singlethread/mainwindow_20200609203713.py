...
#######Sequencer测试序列功能########
    ...
    def on_run_test_sequence_clicked(self):
        ...
        sequencer_thread=SequencerThread()   #需要传入当前激活的终端名
        ...
        sequencer_thread.rec_trigger.connect(self.rec_comdata_slot, Qt.QueuedConnection)  #
        sequencer_thread.send_trigger.connect(sequencer_thread.sendto_comdata_slot)
