...
#
    ...
    def newCom_MdiTread(self,com_treadcounter):  #新建Mdi页串口和新线程
        #创建一个MDIarea的sub窗口
        subwindow = NewMdiSubWindow()
        subwindow.setMain(self)
        self.count = self.count + 1
        # 向sub内部添加QTextEdit控件
        subwindow.setWidget(QtWidgets.QTextEdit())
        # print("subwidget_objname:",sub.widget().objectName())
        subwindow.widget().insertPlainText("self.consoleT_insert\r\n")
        self.console_terminal=subwindow.widget()
        ...
        GlobalVariable.mdisubwindow_objlist.append(subwindow)
