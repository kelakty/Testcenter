...
class NewMdiSubWindow(QtWidgets.QMdiSubWindow):
    ...
    def closeEvent(self, event):
        ...
        if(result == QtWidgets.QMessageBox.Yes):
            ...
            print("待销毁的线程是：", QThread.currentThread(),self.mainwindow.console_terminal_threadpool[self.obj_index])

            self.mainwindow.console_terminal_threadpool[self.obj_index].quit()
            self.mainwindow.console_terminal_threadpool[self.obj_index].wait()
            self.mainwindow.console_terminal_threadpool[self.obj_index].deleteLater()
