...
class LogAnalyzer(QWidget, Ui_loganalyzer):
    ...
    def logextracttoexcel(self):
        ...
        print("第一行内容",self.tableWidget.item(1,1))
    ...
    def on_pushButton_gen_2_clicked(self):
        ...
        for i in range(self.tableWidget.rowCount()):
            for j in range(self.tableWidget.columnCountrowCount()):
                print("表格内容",self.tableWidget.item(i,j).text())
                contentlist.append(self.tableWidget.item(i,j).text()
        contentstr = contentlist[0]
        results = contentstr.split(";")
        print(contentstr)
