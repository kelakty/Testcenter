...
class LogAnalyzer(QWidget, Ui_loganalyzer):
    ...
    def logextracttoexcel(self):
        ...
        exceldata=pd.DataFrame(columns=['SLOTID','Address',"EYE"])  #'L','R','U','D'
                    ...
                    if re_SLOTID.findall(data) != [] or re_Address.findall(data) != []:
                        ...
                        while True:
                            ...
                            if re_EYE.findall(data) != []:
                                ...
                                print("找到EYE是：",find3)
                                print("该行log是：",data)
                                exceldata=exceldata.append([{'SLOTID':find1,'Address':find2,"EYE":find3}], ignore_index=True) 
                                ...
                                for i in range(3):
                                    ...
                                    if not data:
                                        ...
                                        break
                                    if re_EYE.findall(data) != []:
                                        find3.append(re_EYE.findall(data))
                                        print("找到EYE是：",find3)
                                        print("该行log是：",data)
                                        
                                        exceldata=exceldata.append([{'SLOTID':find1,'Address':find2,"EYE":find3}], ignore_index=True) #'L':find3[0],'R':find3[0],'U':find3[0],'D':find3[0]
