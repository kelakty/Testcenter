                        ...
                        while True:
                            ...
                            if re_EYE.findall(data) != [] or re_Address.findall(data) != []:
                                ...
                                if re_EYE.findall(data) != []:
                                    ...
                                    exceldata=exceldata.append([{'SLOTID':find1[0],'Address':find2[0],"EYE":find3}], ignore_index=True) 
                                    ...
                                    for i in range(3):
                                        ...
                                        if re_EYE.findall(data) != []:
                                            ...
                                            exceldata=exceldata.append([{'SLOTID':find1[0],'Address':find2[0],"EYE":find3}], ignore_index=True) #'L':find3[0],'R':find3[0],'U':find3[0],'D':find3[0]
