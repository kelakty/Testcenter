...
class LogAnalyzer(QWidget, Ui_loganalyzer):
    ...
    def logextracttoexcel(self):
        ...
        EYE = "-4    51     0     0,3   25   7  159    0  47,  1,  1,  3,  0,  1     0    16, 68,16, 0, 0, 0     (\d\d\d),(\d\d\d),(\d\d\d),(\d\d\d)"
                            ...
                            if re_EYE.findall(data) != []:
                                ...
                                for i in range(3):
                                    ...
                                    if re_EYE.findall(data) != []:
                                        ...
                                        exceldata=exceldata.append([{'SLOTID':find1,'Address':find2,'L':find3[0],'R':find3[1],'U':find3[2],'D':find3[3]}], ignore_index=True)
