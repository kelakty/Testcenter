...
#
    ...
    def on_open_close_buttom_clicked(self):
        ...
        elif self.console_terminal_threadpool[0] != None:


    def newCom_MdiTread(self,counter): #新建Mdi页串口和新线程
        #创建一个MDIarea的sub窗口
        sub = NewMdiSubWindow()
        sub.setMain(self)
        ...
        #创建新线程，初始化一个串口
        self.console_terminal_threadpool[self.counter] = None
        self.console_terminal_threadpool[counter] = SerialThread() #self.com_option.currentText()
        self.analyze=AnalyzObject()
        self.analyze.moveToThread(self.console_terminal_threadpool[0])
        self.console_terminal_threadpool[counter].started.connect(self.analyze.serial_init)
        ...
        self.console_terminal_threadpool[counter].start() 
