...
class SerialConsoleThread(Console):   #QObject
    ...
    def serial_init(self):
        ...
        if ok:
            ...
            #保存串口obj到字典
            if find_dictionarylist_keyvalue_index(GlobalVariable.Console, "name", self.com_option_name) != False:
                index = find_dictionarylist_keyvalue_index(GlobalVariable.Console, "name", self.com_option_name)
