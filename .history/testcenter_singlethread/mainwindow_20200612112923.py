    ...
    def on_run_test_sequence_clicked(self):
        ...
        if self.mdiArea.currentSubWindow() != None:
            ...
            if self.current_console_index >= 0:
                ...
                # # self.sequencer_threadpool[-1].started.connect(lambda: sequencer_thread.sequencer_init(table_dict_list))
                # self.sequencer_threadpool[-1].started.connect(sequencer_thread.sequencer_init)
                ...
                self.sequencer_thread = SequencerThreadWorker()   #需要传入当前激活的终端名
