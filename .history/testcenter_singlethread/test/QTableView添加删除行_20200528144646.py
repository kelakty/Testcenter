...
class WindowClass(QMainWindow):
    ...
    def __init__(self,parent=None):
        ...
        self.action= QAction("添加",columncount, self)
        self.action2=QAction("删除",self)
        self.tool.addAction(self.action)
        self.tool.addAction(self.action2)
        self.action.triggered.connect(lambda: self.tableWidget.insertColumn(columncount+=1))
        self.action2.triggered.connect(self.tableWidget.removeColumn)
