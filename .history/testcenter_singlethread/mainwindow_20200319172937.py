...
class NewMdiSubWindow(QtWidgets.QMdiSubWindow):
    ...
    def closeEvent(self, event):
        ...
        if(result == QtWidgets.QMessageBox.Yes):
            ...
            print("待销毁的线程是：", QThread.currentThread(),self.mainwindow.console_terminal_threadpool[self.com_threadCounter])
            ...
            GlobalVariable.opencom_objlist[obj_index].close() #关闭串口
