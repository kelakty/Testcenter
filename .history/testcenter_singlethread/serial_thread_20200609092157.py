...
class SerialConsoleThread(Console):   #QObject
    ...
    def serial_init(self):
        ...
        #初始化待保存log处理的中间全局变量
        GlobalVariable.waiting_to_send.update({"threadid": str(QThread.currentThreadId()),"data":{"senddata":[], "residue":""}})
    ...
    def sendto_comdata_slot(self,data):
        ...
        GlobalVariable.waiting_to_send = self.log_post_process.log_joint_and_decode(GlobalVariable.waiting_to_send, data, 'gb2312')
